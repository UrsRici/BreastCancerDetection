...
namespace BrestCancerDetection.Classes
{
    public static class ButtonsInfo
    {
        private static readonly Dictionary<string, string> buttonsInfo = new Dictionary<string, string>
        {
            ...
            { "button_AI", "Aplică algoritmul AI pe întreaga imagine sau pe zonele predefinite pentru detectarea anomaliilor." },
            { "button_AIonROI", "Aplică algoritmul AI pe zona selectată (ROI). Dacă nu ai selectat o zonă, folosește mai întâi butonul 'Select ROI'." },
